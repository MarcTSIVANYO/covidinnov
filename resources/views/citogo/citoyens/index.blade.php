      ...
      <div class="col-md-12 " >  
        <div class="col-md-11" > 
          ...
          <div class="box-header">
            <h2 class="box-title">Liste des citoyens <span class="badge badge-pill badge-primary">{{$objects->count()}}</span></h2>
          </div><!-- /.box-header -->
                        ...
                        <tr> 
                          ...
                          <td>
                            @foreach($types as $val)
                              @if($f->typecitoyen_id==$val->id) 
                                {{$val->titre}}
                              @endif
                            @endforeach 
                          </td> 
                          <td>
                            <a title="Ajouter un enfant" style="text-decoration: none;" class="btn btn-warning " href="{{url('citoyen/'.$f->id)}}">
