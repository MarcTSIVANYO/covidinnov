        ...
        <div class="row">
          ...
          <div class=" panel panel-default"> 
              <div class="box-header">
                <h2 class="box-title">Liste des acteurs <span class="badge badge-pill badge-primary">{{$objects->count()}}</span></h2>
              </div><!-- /.box-header -->
